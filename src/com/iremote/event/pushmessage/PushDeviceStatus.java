...
public class PushDeviceStatus extends ZWaveDeviceEvent implements ITextMessageProcessor{
	
	@Override
	public void run() 
	{
		setWarningstatus(Utils.getJsonArrayLastValue(getWarningstatuses()));
		NotificationHelper.pushDeviceStatus(this, getEventtime() , TlvWrap.readString(getReport(), 12, 4));
	}
