...
public class TlvWrap {
	...
	public static byte[][] splitTag(byte content[] , int index)
	{
		...
		for ( ; index < content.length;)
		{
			...
			byte[] b = new byte[TAGLENGTH_LENGTH + l ] ;
	...
	{
		writeInt(content , TAGLENGTH_LENGTH , value , length);
	}
	...
	{
		System.arraycopy(value, 0, content, TAGLENGTH_LENGTH, value.length);
	}
