...
public class MultiChannelDeviceBinarySwitchReportProcessor extends ZWaveReportBaseProcessor {
	
	public MultiChannelDeviceBinarySwitchReportProcessor() {
		super();
	...
	protected void updateDeviceStatus()
	{
		...
		if ( channel == 0 )  //in case first channel report without 96 command class , channel is 0 .
		{
			return ; //discard report without channel ID.
			//channel = 1 ;
		}
