...
public class LeedarsonSensitivityReportProcessor extends ZWaveReportBaseProcessor{
	...
	protected void updateDeviceStatus() {
		...
		zds.update(zd);
		DeviceOperationSteps qdos = doss.querybyzwavedeviceidandtype(zwavedeviceid, DeviceOperationType.getLeedarsonSensitivity);
		if(qdos==null){
			...
			dos.setOptype(DeviceOperationType.getLeedarsonSensitivity.ordinal());
			dos.setStatus(1);
