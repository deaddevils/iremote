...
public class NEOSilentsecondsReportProcessor extends ZWaveReportBaseProcessor{
	...
	protected void updateDeviceStatus() {
		...
		zds.update(zd);
		DeviceOperationSteps qdos = doss.querybyzwavedeviceidandtype(zwavedeviceid, DeviceOperationType.getNEOSilentseconds);
		if(qdos==null){
			...
			dos.setOptype(DeviceOperationType.getNEOSilentseconds.ordinal());
			dos.setStatus(1);
