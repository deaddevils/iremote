...
public class RandcodeforResetpasswordAction {
	...
	public String execute()
	{
		...
		{
			Randcode r = new Randcode(rc ,countrycode ,phonenumber , 2);
	...
	{
		List<Randcode> lst = svr.querybyphonenumber(countrycode , phonenumber , 2 , platform);
