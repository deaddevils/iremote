...
public class AddPartitionAppliance {
    ...
    public String execute() {
        ...
        if (partitionService.query(partitionid) ==null || (zwavedeviceid == 0 && zwavedevicelist.size() == 0
        		&& cameraid == 0 && cameralist.size() == 0)) {
        ...
        if(zwavedeviceid!=0){
    		...
    		if ( PhoneUserHelper.checkIsMyZWaveDevice(phoneuser, query) == false ){
