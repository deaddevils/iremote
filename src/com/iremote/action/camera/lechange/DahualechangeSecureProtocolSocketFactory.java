...
public class DahualechangeSecureProtocolSocketFactory implements SecureProtocolSocketFactory {
     ...
     */
    public DahualechangeSecureProtocolSocketFactory() {
    }
    ...
    private static SSLContext createEasySSLContext() {
        try {
            ...
            context.init(null, new TrustManager[] {new DahualechangeX509TrustManager()}, null);
            return context;
        } catch (Exception e) {
