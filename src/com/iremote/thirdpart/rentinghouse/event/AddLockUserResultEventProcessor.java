...
public class AddLockUserResultEventProcessor extends ZWaveDeviceEvent implements ITextMessageProcessor {

    @SuppressWarnings("unused")
    private static Log log = LogFactory.getLog(AddLockUserResultEventProcessor.class);
