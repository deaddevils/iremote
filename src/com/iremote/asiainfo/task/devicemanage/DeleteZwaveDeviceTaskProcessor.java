...
public class DeleteZwaveDeviceTaskProcessor implements Runnable {
	...
	public DeleteZwaveDeviceTaskProcessor(PhoneUser user,
			ZWaveDevice device, List<PhoneUser> shareuses) {
		super();
		this.user = user;
		this.device = device;
