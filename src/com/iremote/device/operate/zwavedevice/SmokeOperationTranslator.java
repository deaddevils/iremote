...
public class SmokeOperationTranslator extends OperationTranslatorBase{

	@Override
	public String getDeviceStatus() {
		if ( StringUtils.isNoneBlank(this.devicestatus))
			return this.devicestatus;
		if ( this.status != null && this.status == IRemoteConstantDefine.DEVICE_STATUS_SMOKE)
			this.devicestatus = IRemoteConstantDefine.WARNING_TYPE_SMOKE;
		return devicestatus;
	}
	...
	public Integer getValue() {
		...
		{
			if ( IRemoteConstantDefine.WARNING_TYPE_SMOKE.equals(this.devicestatus) )
				this.status = IRemoteConstantDefine.DEVICE_STATUS_SMOKE ;
