...
public class WaterOperationTranslator extends OperationTranslatorBase{

	@Override
	public String getDeviceStatus() {
		if ( StringUtils.isNoneBlank(this.devicestatus))
			return this.devicestatus;
		if ( this.status != null && this.status == IRemoteConstantDefine.DEVICE_STATUS_WATER_LEAK)
			this.devicestatus = IRemoteConstantDefine.WARNING_TYPE_WATER_LEAK;
		return devicestatus;
	}
	...
	public Integer getValue() {
		...
		{
			if ( IRemoteConstantDefine.WARNING_TYPE_WATER_LEAK.equals(this.devicestatus) )
				this.status = IRemoteConstantDefine.DEVICE_STATUS_WATER_LEAK ;
