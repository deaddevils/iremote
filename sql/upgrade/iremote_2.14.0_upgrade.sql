...
INSERT INTO `messagetemplate` (`platform`, `language`, `key`, `value`,`alitemplatecode`,`alitemplateparam`) VALUES('7','en_US','invation','Your friend ${phonenumber} invites you to trial-use iSurpass，and the download address is as below：http://irtsg.isurpass.com.cn/iremote/download?platform=7',NULL , NULL);
INSERT INTO `messagetemplate` (`platform`, `language`, `key`, `value`,`alitemplatecode`,`alitemplateparam`) VALUES('7','zh_CN','invation','您的朋友${phonenumber},邀请您试用iSurpass，下载地址：http://irtsg.isurpass.com.cn/iremote/download?platform=7',NULL , NULL);
