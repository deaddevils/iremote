...
public class LockSimulatorMessageHandler extends SimpleChannelInboundHandler<byte[]>
{
	private static Log log = LogFactory.getLog(LockSimulatorMessageHandler.class);
	...
	protected void channelRead0(ChannelHandlerContext ctx, byte[] content) throws Exception 
	{
		...
		IRemoteRequestProcessor pro = LockSimulatorProcessorStore.getInstance().getProcessor(content , 0);
