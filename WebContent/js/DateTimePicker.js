...
;(function ( $, window, document, undefined ) {
		...
		var defaults = {
			...
			shortDayNames: lbl_shortDayNames,
			fullDayNames: lbl_fullDayNames,
			shortMonthNames: ["01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12"],
			fullMonthNames: ["01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12"],
		
			titleContentDate: "Set Date",
			titleContentTime: "Set Time",
			titleContentDateTime: lbl_titleContentDateTime,
		
			buttonsToDisplay: ["HeaderCloseButton", "SetButton", "ClearButton"],
			setButtonContent: lbl_setButtonContent,
			clearButtonContent: lbl_clearButtonContent,
		...
		DateTimePicker.prototype = {
			...
			_setCurrentDate: function()
			{
				...
				else if(dtPickerObj._compare(dtPickerObj.settings.mode, "datetime"))
				{
					...
					var sDate = sYear + "- " + sMonthFull + "- " + sDay + "  " + sDayOfTheWeek;
