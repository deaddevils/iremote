...
<title><s:text name="mailresetpassword_title" /></title>
</head>
<body>
<style type="text/css">
	.text_left
...
<script type="text/javascript">
    function resetpassword(){
        ...
        $.ajax({
            type: "post",
            url:"/iremote/mailuser/resetpassword",
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td colspan="2" align="center"><input class="btn_success" type="button" onclick="resetpassword()" name="OK" value="OK"/></td>
	</tr>
</table>
</form>
</body>
