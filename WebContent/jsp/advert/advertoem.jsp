			...
			<div class="slider-wrapper theme-default" style="margin:0px;padding:0px;widht:100%;height:100%">
					...
					<s:else>
						...
						<s:if test=" adverpicname == null ">
				         	<img src="images/advert_oem/home_img_zh.png" style="margin:0px;padding:0px;width:100%;height:100%"/>
						</s:if>  
						<s:else>
							<s:iterator value="adverpicname" id="apn">
								<img src="images/advert_oem/<s:property value='platform'/>/<s:property value='#apn'/>" style="margin:0px;padding:0px;width:100%;height:100%"/>
							</s:iterator>
						</s:else>
					</s:else>
