    ...
    <body style="margin:0px;padding:0px">
         <div class="slider-wrapper theme-default" style="margin:0px;padding:0px;widht:100%;height:100%">
				...
				<s:else>
           	 	...
           	 	<s:iterator value="picurllist" id="url">
	           	 		<img style="width:100%;height:100%" src="<s:property value='#url'/>" data-thumb="<s:property value='#url'/>" alt="" style="margin:0px;padding:0px;widht:100%;height:100%"/>
	           	 </s:iterator>	
