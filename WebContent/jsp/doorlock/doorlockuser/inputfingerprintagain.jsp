...
<title><s:text name="enterfingerprintagain" /></title>
...
{
	if ( data.status != 'inputfingerprintagain')
...
<img src="/iremote/images/lock/lock_fingerprintsuccess_img.gif" class="tip_img"/>
<br>
<span class="message"><s:text name="enterfingerprintonthedoorlockagain" /></span>
</center>
