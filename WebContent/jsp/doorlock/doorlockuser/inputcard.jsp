...
<title><s:text name="swipeyourcard" /></title>
...
<img src="/iremote/images/lock/lock_img_card.gif" class="tip_img"/>
<br>
<span class="message"><s:text name="swipecardatthedooraccess" /></span>
</center>
