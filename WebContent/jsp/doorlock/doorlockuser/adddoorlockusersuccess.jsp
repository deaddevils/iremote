...
<title><s:text name="addsuccessfully" /></title>
...
<img src="/iremote/images/lock/lock_img_tjcg.png" class="tip_img"/>
<br>
<span class="message"><s:text name="adddoorlockusersuccessfully" /></span>
<br>
