...
function setandget(o,b){
	...
	$.ajax({
        type: "post",
        url:"/iremote/device/setandgetleedarsonstatus",
        data:data,
        async: false,
        success : function(data) {
        	if(data.resultCode==0){
...
<form action="/iremote/device/setdeivityname" id="formSumbit" method="post">
	...
	<table  width="100%">
		...
		<tr>	
			...
			<output></output>
	        <input id="Slider1" name="sensitivity" type="range" min="1" max="10" value="10" data-rangeslider/>
			</td>
		</tr>
		<tr>	
			<td align="right"><s:text name="low" /></td>
			<td align="center" colspan="3">
			</td>
			<td align="left"><s:text name="high" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<input id="Slider2" name="silentseconds" type="range" min="5" max="600" value="30" data-rangeslider/></td>
		</tr>
		...
		<tr height="25px"><td colspan="5" align="left"><s:text name="leedarsontip1"/></td></tr>
		<tr height="25px"><td colspan="5" align="left"><s:text name="leedarsontip2"/></td></tr>
		<tr height="25px"><td colspan="5" align="left"><s:text name="leedarsontip3"/></td></tr>
		<tr height="25px"><td colspan="5" align="left"><s:text name="leedarsontip4"/></td></tr>
		<tr height="25px"><td colspan="5" align="left"><s:text name="leedarsonnote"/></td></tr>
	</table>
</form>
